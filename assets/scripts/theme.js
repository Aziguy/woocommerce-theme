...
function swithcerMenu() {
  if ($(".switch_menu").length) {
    ...
    $("#styleOptions .color1").on("click", function () {
      $(".logo img,.sticky_logo img,.footer_logo a>img").attr(
        "src",
      ...
      Cookies.set("logo-img", "images/logo/logo.png", {
        expires: 365,
        path: "/",
      });
      Cookies.set("logo-img-footer", "images/logo/logo.png", {
        expires: 365,
        path: "/",
      });
    ...
    $("#styleOptions .color2").on("click", function () {
      ...
      Cookies.set("logo-img", "images/logo/logo2.png", {
        expires: 365,
        path: "/",
      });
      Cookies.set("logo-img-footer", "images/logo/logo2.png", {
        expires: 365,
        path: "/",
      });
    ...
    $("#styleOptions .color3").on("click", function () {
      ...
      Cookies.set("logo-img", "images/logo/logo3.png", {
        expires: 365,
        path: "/",
      });
      Cookies.set("logo-img-footer", "images/logo/logo3.png", {
        expires: 365,
        path: "/",
      });
    ...
    $("#styleOptions .color4").on("click", function () {
      ...
      Cookies.set("logo-img", "images/logo/logo4.png", {
        expires: 365,
        path: "/",
      });
      Cookies.set("logo-img-footer", "images/logo/logo4.png", {
        expires: 365,
        path: "/",
      });
